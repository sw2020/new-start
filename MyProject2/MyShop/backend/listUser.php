...
$rows = getRowsByPage($page,$pageSize,"commonuser",$where);
// if (!$rows){
// 	alertMes("没有用户，请先添加用户！", "index.php");
// }
?>
<!DOCTYPE html>
<html lang="zh-cn">
  <head>
    ...
    <script type="text/javascript" src="js/bootstrap.min.js" ></script>
  	<script>
  		$(function(){
			$('.navbar-slide').children('li').eq(4).addClass('active');
			$('.active > ul').css('display', 'block');

			$("#search_btn").click(function(){
				var val = $("#User_val").val();
				window.location="listUser.php?keyword="+val;
			});
  		...
  		function delAdmin(id){
  			window.location="../core/user.inc.php?act=delUser&id="+id;
  		}
  	</script>
  <body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="right-slide col-md-10 col-sm-10 col-xs-12 pull-right">
				...
				<?php require 'module/listUser.php';?>
				</div>
			</div>
		</div>
	</div>
