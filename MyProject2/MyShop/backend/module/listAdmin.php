				<div class="right-slide-head">
					...
					<button onclick="addAdmin()" type="button" class="btn"><span class="glyphicon glyphicon-plus"></span> 添加</button>
<!-- 					<button type="button" class="btn"><span class="glyphicon glyphicon-trash"></span> 删除</button><br /><br /> -->
					<div class="row" style="padding-right: 20px; width: 99%;">
						<div class="col-md-9">
							<div class="form-group form-inline"><label class="control-label">请输入要查询的名称</label> <input type="text" class="form-control" id="search_val" /></div>
						</div>
						<div class="col-md-3">
					...
					<table class="table table-bordered">
						...
						<?php foreach ($rows as $row): ?>
							<tr>
								...
								<td>
									<a onclick="editAdmin(<?php echo  $row['id'];?>)"><span class="glyphicon glyphicon-pencil"></span> 修改</a>&nbsp;
									<a onclick="delAdmin(<?php echo  $row['id'];?>)"><span class="glyphicon glyphicon-trash"></span> 删除</a>
								</td>
							</tr>
