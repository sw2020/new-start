...
$where =$keyword?"where cateName like '%{$keyword}%'":null;
$pageSize = 5;
$page = $_REQUEST['page']?(int)$_REQUEST['page']:1;
$rows = getRowsByPage($page,$pageSize, "cate",$where);
?>
<!DOCTYPE html>
<html lang="zh-cn">
  <head>
    ...
    <script type="text/javascript" src="js/bootstrap.min.js" ></script>
  	<script>
  		$(function(){
			$('.navbar-slide').children('li').eq(1).addClass('active');
			$('.active > ul').css('display', 'block');
			//搜索
			$("#search_btn").click(function(){
				var val = $("#cateName_val").val();
				window.location="listCate.php?keyword="+val;
			});
  		...
  		function delCate(id){
  			window.location="../core/cate.inc.php?act=delCate&id="+id;
  		}
  	</script>
  <body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="right-slide col-md-10 col-sm-10 col-xs-12 pull-right">
				...
				<?php require 'module/listCate.php';?>
				</div>
			</div>
		</div>
	</div>
