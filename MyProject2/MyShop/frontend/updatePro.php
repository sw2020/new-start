	...
	<body>
		<div class="header" id="top">
			...
			<div class="container" style="min-height: 900px">
				...
				<form id="add_pro_form" class="updatePro" action="../core/pro.inc.php?act=addPro&promulgator=F<?php echo $_COOKIE['adminId2']?>" method="post" enctype="multipart/form-data">
					
					<P><label>商品名称：</label>
					<input name="Pname" type="text" class="form-control" style="max-width: 550px;margin: 8px 0 15px 0;" /></P>
					...
					<P>
					<label>商品价格：</label>
					<input name="mPrice" type="text" class="form-control" style="max-width: 550px;margin: 8px 0 15px 0;" /></P>
					
					<P><label>商品原价：</label>
					<input name="iPrice" type="text" class="form-control" style="max-width: 550px;margin: 8px 0 15px 0;" /></P>
					<P><label>成色：</label>
					<input name="NewOrOld" type="text" class="form-control" style="max-width: 550px;margin: 8px 0 15px 0;" /></P>
					<P><label>地址：</label>
					<input name="address" type="text" class="form-control" style="max-width: 550px;margin: 8px 0 15px 0;" /></P>
