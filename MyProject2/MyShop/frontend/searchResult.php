	...
	<div class="container" style="min-height:600px">
		<div class="up-position">
			<ul>
				...
				<li>搜索结果<span>(共找到 <?php echo $num;?> 个搜索结果)</span></li>
			</ul>
		</div>
		...
		<?php foreach ($rows as $row):?>
			<div class="col-sm-3 sale_panel">
				<a href="pro/<?php echo $row['id']?>.php" class="thumbnail">
					<img src="../image_220/<?php $id = $row['id'] ;$img=getByIdImg($id);echo $img['albumPath']?>" alt="#"/>
				</a>
				<h4><a href="pro/<?php echo $row['id']?>.php"><?php echo $row['Pname']?></a></h4>
				<p><a class="about_Pro" href="pro/<?php echo $row['id']?>.php"><?php echo $row['Pdesc']?></a></p>
				<div class="price_buy">
					<span class="sec3-price">￥<?php echo $row['iPrice']?></span>
					<a href="pro/<?php echo $row['id']?>.php"><span class="sec3-button pull-right">立即抢购</span></a>						
				</div>		
