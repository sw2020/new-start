			...
			<div class="header-menu">
				<div class="container">
					...
					<ul class="col-xs-7">
						...
						<li><a href="#"><?php $where=2;  $row=getOneCate($where); echo $row['cateName'];?></a></li>
	...
	<div class="container" style="min-height: 600px">
		...
		<?php foreach ($pros as $pro):?>
			<div class="col-sm-3 sale_panel">
				...
				<h4><a href="#"><?php echo $pro['Pname']?></a></h4>
				<p><a class="about_Pro" href="#"><?php echo $pro['Pdesc']?></a></p>
				<div class="price_buy">
					<span class="sec3-price">￥<?php echo $pro['iPrice']?></span>
					<a href=" ProductDetails.html"><span class="sec3-button pull-right">立即抢购</span></a>						
				</div>		
